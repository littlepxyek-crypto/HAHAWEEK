...
| External community participant | **No authority over evidence truth or validation** | No special authority | No special authority | PoO boundary |
...
9. External community participants have authority over evidence or validation.
...
In particular, HAHAWEEK does not claim that arbitrary state labels are mechanically impossible to misrepresent as financial signals merely because this document rejects that interpretation.
