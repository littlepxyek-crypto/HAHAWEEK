...
test('V4 authority failure rolls back evidence and cursor together', async () => {
  ...
  await assert.rejects(() => engine.runOnce(), /AUTHORITY_FAILURE/);
