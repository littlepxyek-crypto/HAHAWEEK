...
test('current PROJECT_STATE is valid and exposes STEP 613 Security/Regression authority', () => {
  ...
  assert.equal(result.next_step, 'CI for STEP 613 is authorized by the verified Security/Regression phase');
});
