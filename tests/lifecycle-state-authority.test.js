...
test('current PROJECT_STATE is valid and exposes STEP 613 Reconciliation authority', () => {
  ...
  assert.equal(result.next_step, 'Documentation for STEP 613 is authorized by verified Reconciliation');
});
