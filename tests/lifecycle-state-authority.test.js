...
test('current PROJECT_STATE is valid and exposes STEP 613 Test authority', () => {
  ...
  assert.equal(result.next_step, 'Security/Regression for STEP 613 is authorized by the verified Test phase');
});
