...
test('current PROJECT_STATE is valid and exposes STEP 613 Documentation authority', () => {
  ...
  assert.equal(result.next_step, 'No new numbered STEP is authorized by this reconciliation; global LIVE-READINESS remains blocked by unverified actual operator runtime evidence');
});
