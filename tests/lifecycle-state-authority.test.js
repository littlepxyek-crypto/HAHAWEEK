...
test('current PROJECT_STATE is valid and exposes STEP 613 CI authority', () => {
  ...
  assert.equal(result.next_step, 'Review for STEP 613 is authorized by the verified CI phase');
});
